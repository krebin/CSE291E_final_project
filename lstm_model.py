...
class LSTMModel(nn.Module):
    ...
    def __init__(self, num_features=51):
        ...
        self.lstm_1 = nn.LSTM(input_size=(200+self.num_features), hidden_size=250, num_layers=2, batch_first=True, bidirectional=True)
        self.lstm_2 = nn.GRU(input_size=500, hidden_size=500, num_layers=2, batch_first=True, bidirectional=True)
        self.lstm_3 = nn.GRU(input_size=500, hidden_size=500, num_layers=2, batch_first=True, bidirectional=True)
